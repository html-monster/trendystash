<?php
class Addweb_AdvReservation_Model_Catalog_Product_Option_Type_Date extends Mage_Catalog_Model_Product_Option_Type_Date
{
    /**
...
//                $timestamp += 60 * 60 * $value['hour'] + 60 * $value['minute'];
    ...
    public function getFormattedOptionValue($optionValue)
    {
        if ($this->_formattedOptionValue === null) {
            ...
            $option = $this->getOption();
            if ($this->getOption()->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE) {
                $format = Mage::app()->getLocale()->getDateFormat(Mage_Core_Model_Locale::FORMAT_TYPE_MEDIUM);
                $result = Mage::app()->getLocale()->date($optionValue, Zend_Date::ISO_8601, null, false)
                    ->toString($format);
            } elseif ($this->getOption()->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TO_DATE) {
            ...
            } elseif ($this->getOption()->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FROM_DATE) {
                $format = Mage::app()->getLocale()->getDateTimeFormat(Mage_Core_Model_Locale::FORMAT_TYPE_SHORT);
                $result = Mage::app()->getLocale()
                    ->date($optionValue, Varien_Date::DATETIME_INTERNAL_FORMAT, null, false)->toString($format);
            } elseif ($this->getOption()->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE_TIME) {
                $format = Mage::app()->getLocale()->getDateTimeFormat(Mage_Core_Model_Locale::FORMAT_TYPE_SHORT);
                $result = Mage::app()->getLocale()
                    ->date($optionValue, Varien_Date::DATETIME_INTERNAL_FORMAT, null, false)->toString($format);
            } elseif ($this->getOption()->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TIME) {
    ...
    protected function _dateExists()
    {
        return in_array($this->getOption()->getType(), array(
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TO_DATE,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FROM_DATE,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE_TIME
        ));
    }
    ...
    protected function _timeExists()
    {
        return in_array($this->getOption()->getType(), array(
			...
			Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TO_DATE,
			Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FROM_DATE,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TIME
        ));
    }
}
