<?php
class Addweb_AdvReservation_Model_Catalog_Product_Option_Type_Select extends Mage_Catalog_Model_Product_Option_Type_Select
{
    /**
    ...
    {
        $_single = array(
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DROP_DOWN,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_ADULTS,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_CHILDS,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_RESERVE_TYPE,
            Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_RADIO
        );
