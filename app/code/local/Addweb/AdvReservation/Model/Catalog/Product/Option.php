<?php
/* 
 * add new type adults, childs, reserve_type, to_date, from_date  add const in customization
*/
class Addweb_AdvReservation_Model_Catalog_Product_Option extends Mage_Catalog_Model_Product_Option
{
    /**
     * Option group text
     */
     ...
     * Option type adults
     */
    const OPTION_TYPE_ADULTS  = 'adults';
	
	 /**
     * Option type childs
     */
    const OPTION_TYPE_CHILDS  = 'childs';
	
	 /**
     * Option type reserve_type
     */
    const OPTION_TYPE_RESERVE_TYPE  = 'reserve_type';
     ...
     * Option type to_date
     */
    const OPTION_TYPE_TO_DATE      = 'to_date';
	
    /**
     * Option type from_date
     */
    const OPTION_TYPE_FROM_DATE      = 'from_date';
     ...
     * @param string $type
     * @return string
	 * Add type const name in this array 
     */
    public function getGroupByType($type = null)
    {
        ...
        $optionGroupsToTypes = array(
            ...
            self::OPTION_TYPE_ADULTS => self::OPTION_GROUP_SELECT,
            self::OPTION_TYPE_CHILDS => self::OPTION_GROUP_SELECT,
            self::OPTION_TYPE_RESERVE_TYPE => self::OPTION_GROUP_SELECT,
            self::OPTION_TYPE_DATE => self::OPTION_GROUP_DATE,
            self::OPTION_TYPE_TO_DATE => self::OPTION_GROUP_DATE,
            self::OPTION_TYPE_FROM_DATE => self::OPTION_GROUP_DATE,
