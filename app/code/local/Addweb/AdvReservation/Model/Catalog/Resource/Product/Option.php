<?php
class Addweb_AdvReservation_Model_Catalog_Resource_Product_Option extends Mage_Catalog_Model_Resource_Product_Option
{
    /**
    ...
    protected function _saveValuePrices(Mage_Core_Model_Abstract $object)
    {
		 ...
		 * Add class Addweb_AdvReservation_Model_Catalog_Product_Option and add custom option type of to_date and from_date
         */

        if ($object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FIELD
            || $object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_AREA
            || $object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FILE
            || $object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE
            || $object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TO_DATE
            || $object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FROM_DATE
            || $object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE_TIME
            || $object->getType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TIME
        ) {
            //save for store_id = 0
     ...
     *
     * @param Addweb_AdvReservation_Model_Catalog_Product_Option $object
     * @param int $oldProductId
     * @param int $newProductId
     * @return Addweb_AdvReservation_Model_Catalog_Product_Option
     */
    public function duplicate(Addweb_AdvReservation_Model_Catalog_Product_Option $object, $oldProductId, $newProductId)
    {
