<?php
/* 
* Replace class Mage_XmlConnect_Block_Catalog_Product_Options to Addweb_AdvReservation_Block_XmlConnect_Catalog_Product_Options 
*/
class Addweb_AdvReservation_Block_XmlConnect_Catalog_Product_Options extends Mage_XmlConnect_Block_Catalog_Product_Options
{
     /**#@+
     * Option input type
     */
     ...
     * @return string
	 * 
	 * Addweb AdvReservation add case for add new type on product custom option adults, childs and reserve type for select option.
     */
    protected function _getOptionTypeForXmlByRealType($realType)
    {
        switch ($realType) {
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DROP_DOWN:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_ADULTS:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_CHILDS:
            ...
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_RADIO:
                ...
                break;
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_MULTIPLE:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_CHECKBOX:
                $type = self::OPTION_TYPE_CHECKBOX;
                break;
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FIELD:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_AREA:
            default:
    ...
    protected function _setCartSelectedValue($xmlItem, $type, $value = null)
    {
        ...
        switch ($type) {
            ...
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_RADIO:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_MULTIPLE:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_GROUP_SELECT:
            ...
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FIELD:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_AREA:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FILE:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE:
			case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TO_DATE:
			case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_FROM_DATE:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_TIME:
            case Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_TYPE_DATE_TIME:
            default:
