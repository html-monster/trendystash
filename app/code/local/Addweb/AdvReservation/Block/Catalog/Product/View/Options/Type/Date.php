<?php
class Addweb_AdvReservation_Block_Catalog_Product_View_Options_Type_Date extends Mage_Catalog_Block_Product_View_Options_Type_Date
{
    ...
    public function getCalendarDateHtml()
    {
        ...
        $calendar = $this->getLayout()
			...
			->setCustomId('options_'.$this->getOption()->getType())
