<?php
class Addweb_AdvReservation_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Select extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Type_Select
{
    /**
     * Class constructor
     */
    ...
    {
        parent::__construct();
		// select.phtml file call as Addweb_AdvReservation module adminhtml path addweb folder
        $this->setTemplate('addweb/catalog/product/edit/options/type/select.phtml');
