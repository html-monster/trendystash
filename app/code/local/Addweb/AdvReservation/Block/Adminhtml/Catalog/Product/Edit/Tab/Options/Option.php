<?php
class Addweb_AdvReservation_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option
{
    protected $_product;
    ...
    {
        parent::__construct();
		// option.phtml file call as Addweb_AdvReservation module adminhtml path addweb folder
        $this->setTemplate('addweb/catalog/product/edit/options/option.phtml');
...
//        $optionsArr = $this->getProduct()->getOptions();
        ...
        if (!$this->_values) {
            ...
            foreach ($optionsArr as $option) {
                ...
                if ($option->getGroupByType() == Addweb_AdvReservation_Model_Catalog_Product_Option::OPTION_GROUP_SELECT) {
...
//                    $valuesArr = array_reverse($option->getValues(), true);
                    ...
                    foreach ($option->getValues() as $_value) {
                        ...
                        $value['optionValues'][$i] = array(
							...
							'max_adults' => $this->escapeHtml($_value->getMaxAdults()),
							'max_childs' => $this->escapeHtml($_value->getMaxChilds()),
                        );
...
//                     $s1 = '$value[\'price_type\']='.var_export($value['price_type'], 1)."\n";
